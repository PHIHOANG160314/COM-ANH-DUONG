# 🔥 Bestseller Feature - SQL Setup

## Yêu cầu

Chạy SQL migration để kích hoạt tính năng "Món Bán Chạy" trên trang chủ.

## Hướng dẫn

### Bước 1: Mở Supabase Dashboard

Vào link: https://supabase.com/dashboard/project/rnhtfaxqnvikedwufvcd/sql
...
1. Vào Table Editor → Tìm table `featured_items_config`
2. Phải có 1 row với `mode = 'auto'` và `auto_count = 6`

## Kết quả

✅ Homepage sẽ hiển thị section "🔥 Món Bán Chạy Nhất"

- Auto mode: Tự động lấy từ dữ liệu orders 7 ngày
- Manual mode: Admin chọn món để đẩy sale

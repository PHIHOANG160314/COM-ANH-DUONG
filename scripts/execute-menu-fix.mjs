...
async function executeMenuFix() {
  ...
  const newItems = [
    ...
    { name: 'Cá he kho - mềm xương', price: 45000, category_id: 'rice', is_available: true },
  ...
  if (caHeKho.price !== 45000) {
    console.error(`❌ WRONG PRICE! Expected 45000, got ${caHeKho.price}`);
    process.exit(1);
  }
